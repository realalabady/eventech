        ...
        return (
          <li key={channel.id}>
            <button
              ...
              data-active={active}
              className="relative flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-start text-sm transition-colors duration-150 hover:text-foreground data-[active=false]:text-muted-foreground"
            >
              {active ? (
                <motion.span
